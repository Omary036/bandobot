		...
		<div class="container">
			<div class="pricings">
				...
				<div class="pricing">
					...
					<button class ="btn" onclick="location.href='/we-are-fixing-currently-give-it-a-few-days-to-done-this/sorry'">Upgrade</button>
				</div>
				<div class="pricing">
					<span><i class="fas fa-hashtag"></i> etc</span>
					<button class ="btn blue" onclick="location.href='/we-are-fixing-currently-give-it-a-few-days-to-done-this/sorry'">Upgrade</button>
				</div>
				<div class="pricing">
